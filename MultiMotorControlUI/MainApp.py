'''
iQMed Innovation: User Ineterface Software for Multiple NiMotion's Brushless Motors Control
Application:    Heart in the Box (HiB) , 
                Kidney in the Box (KiB)
Coding:         Weerayot Aramphianlert
Version:        1.0.0
Updated:        10.03.2022
'''
...
class NiMotorControlUI(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Multiple NiMotor Control V1.0.0")
        # self.resize(250,750)
        self.show()
